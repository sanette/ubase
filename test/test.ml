let test_viet () =
  ...
  let b = Ubase.from_utf8_string "Vũ Ngọc Phan (1902-1987) là nhà văn, nhà nghiên cứu văn học hiện đại và văn học dân gian Việt Nam. Trong những năm đầu cầm bút, ông còn có bút danh là Chỉ Qua Thị."
  =
...
let test_french () =
  ...
  let b = Ubase.from_utf8_string "Cette princesse était belle, quoiqu’elle eût passé la première jeunesse ; elle aimait la grandeur, la magnificence et les plaisirs. Le roi l’avait épousée lorsqu’il était encore duc d’Orléans, et qu’il avait pour aîné le dauphin, qui mourut à Tournon, prince que sa naissance et ses grandes qualités destinaient à remplir dignement la place du roi François premier, son père."
  =
